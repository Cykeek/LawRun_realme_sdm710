...
struct xfrm_policy *xfrm_policy_bysel_ctx(struct net *net, u32 if_id, const struct xfrm_mark *mark,
...
struct xfrm_policy *xfrm_policy_byid(struct net *net, u32 if_id, const struct xfrm_mark *mark,
